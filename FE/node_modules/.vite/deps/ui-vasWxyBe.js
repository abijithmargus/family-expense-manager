				...
				e.MakeImageFromCanvasImageSource = function(a) {
					...
					a.Id = a.Id || [], a.Id.push(function() {
						...
						a.Paragraph.prototype.getRectsForRange = function(d, A, U, X) {
							...
							return d.heightMultiplier ??= -1, d.maxLines = d.maxLines || 0, d.replaceTabCharacters = d.replaceTabCharacters || !1, A = (A = d.strutStyle) || {}, A.strutEnabled = A.strutEnabled || !1, A.strutEnabled && Array.isArray(A.fontFamilies) && A.fontFamilies.length ? (A._fontFamiliesPtr = y(A.fontFamilies), A._fontFamiliesLen = A.fontFamilies.length) : (A._fontFamiliesPtr = L, A._fontFamiliesLen = 0), A.fontStyle = c(A.fontStyle), A.fontSize ?? (A.fontSize = -1), A.heightMultiplier ?? (A.heightMultiplier = -1), A.halfLeading = A.halfLeading || !1, A.leading = A.leading || 0, A.forceStrutHeight = A.forceStrutHeight || !1, d.strutStyle = A, d.textAlign = d.textAlign || a.TextAlign.Start, d.textDirection = d.textDirection || a.TextDirection.LTR, d.textHeightBehavior = d.textHeightBehavior || a.TextHeightBehavior.All, d.textStyle = a.TextStyle(d.textStyle), d.applyRoundingHack = d.applyRoundingHack !== !1, d;
...
//# sourceMappingURL=ui-vasWxyBe.js.map